...
public class LinkedListIndexedCollection<T> implements List<T>{
	...
	private static class LinkedListElementsGetter<E> implements ElementsGetter<E> {
		LinkedListIndexedCollection<E> reference;
		private ListNode<E> elementToGet;
		 ...
		 */
		private LinkedListElementsGetter(LinkedListIndexedCollection<E> reference,long modificationCount) {
		...
		public E getNextElement() {
			...
			ListNode<E> helpingNode = elementToGet;
	...
	public void add(T value) {
		ListNode<T> addedNode = new ListNode<T>(last,null,value);
		if(size == 0) {
			first = addedNode;
		}
		else {
	...
	public void insert(T value, int position) {
		...
		if(helpingNode == first) {
			helpingNode = new ListNode<T>(null,first,value);
			first = helpingNode;
		} else {
			ListNode<T> insertedNode = new ListNode<T>(helpingNode,helpingNode.next,value);
